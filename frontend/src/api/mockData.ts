...
export const mockBoard: Board = {
  ...
  columns: [
    ...
    { id: COL_PROGRESS, boardId: BOARD_ID, name: 'In Progress',      type: 'Agent', position: 2, autoForward: true,  agentEnabled: true,  timeoutSeconds: 300, maxAgentTurns: 20,
      instructions: 'Implement the specification. Work in the provided worktrees. Commit your changes.' },
    { id: COL_REVIEW,   boardId: BOARD_ID, name: 'Code Review',      type: 'Agent', position: 3, autoForward: true,  agentEnabled: true,  timeoutSeconds: 300, maxAgentTurns: 10,
    ...
    { id: COL_TESTING,  boardId: BOARD_ID, name: 'Testing',          type: 'Agent', position: 4, autoForward: false, agentEnabled: true,  timeoutSeconds: 300, maxAgentTurns: 10,
      backwardTargetColumnId: COL_PROGRESS,
      instructions: 'Run the test suite in both repos. Verify all acceptance criteria are met.' },
    { id: COL_DONE,     boardId: BOARD_ID, name: 'Done',             type: 'Input', position: 5, autoForward: false, agentEnabled: false, timeoutSeconds: 0,   maxAgentTurns: 0  },
  ],
  repositories: [
